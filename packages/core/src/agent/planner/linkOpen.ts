...
export async function decideLinkOpen(args: {
  ...
  const sys = [
    ...
    "- If the assistant draft clearly states it is opening a link now (not asking permission), open=true.",
    "- If the assistant draft asks for permission (e.g. 'Would you like me to open it?' / 'Say open it'), open=false.",
