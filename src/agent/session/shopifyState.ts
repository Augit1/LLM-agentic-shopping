// src/agent/session/shopifyState.ts
...
/**
 * Planner summaries should be UNIQUE-ish, otherwise the planner sees
 * 8 near-identical variants and decides "nothing better exists".
 *
 * IMPORTANT: we do NOT modify the underlying session.lastShopifyOptions here,
 * because checkout_url is tied to each option_index/variant.
 */
